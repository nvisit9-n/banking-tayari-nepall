      ...
      >
        ...
        <div className="flex items-center gap-2.5 shrink-0 w-full md:w-auto relative z-10">
          <button
            ...
            className="w-full md:w-auto px-5 py-3 rounded-2xl bg-[#1E40AF] hover:bg-blue-800 text-white font-black text-xs sm:text-sm flex items-center justify-center gap-2 shadow-sm transition cursor-pointer active:scale-95"
          >
            <BookOpen className="w-4 h-4 fill-current" />
            <span>नोट्स हब खोल्नुहोस्</span>
